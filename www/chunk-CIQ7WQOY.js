...
var y = (n3) => __async(null, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./p-C1aScSTo-SEX6TBPW.js")).iosTransitionAnimation : (yield import("./p-DIE4pXMl-HCDEVZBA.js")).mdTransitionAnimation;
});
var h = (n3, e) => __async(null, null, function* () {
  yield k(e, true);
...
var P2 = (e) => __async(null, null, function* () {
  ...
  return yield k(e, o), j(i2, a), E(i2, a), { hasCompleted: true };
});
...
var D = (n3) => __async(null, null, function* () {
  const e = n3;
  if (e) {
...
@ionic/core/components/p-CtukzcyX.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CIQ7WQOY.js.map
